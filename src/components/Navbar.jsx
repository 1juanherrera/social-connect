...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="../assets/Mask group.png" className="h-8" alt="Flowbite Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Social Connect</span>
  </a>
  <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" className="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <span className="sr-only">Open user menu</span>
    <div className="w-10 h-10 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500"></div>
      </button>
